...
def Recommendation_DB():
  ...
  for i in crypto_name:
    db = pymysql.connect(host='35.76.154.105', port=8999, user='root', passwd='multi1203',db='upbit', charset='utf8')
  ...
  daily_engine = create_engine("mysql+mysqldb://root:multi1203@35.76.154.105:8999/Recommendation", encoding='utf-8',pool_size = 100000,max_overflow = 0)
...
def input_n_bounds_alevel_output_crypto(n,bounds,input_amplitude_level_p,input_amplitude_level_s):
  ...
  db_p = pymysql.connect(host='35.76.154.105', port=8999, user='root', passwd='multi1203',db='Recommendation', charset='utf8')
  ...
  db_s = pymysql.connect(host='35.76.154.105', port=8999, user='root', passwd='multi1203',db='Recommendation2', charset='utf8')
